module Bitmap (Bitmap,Bitmap.initialize) where
...
initialize wWidth wHeight bmWidth bmHeight = do
    ...
    return (True, Just $ Bitmap vertexArray vertexBuffer indexBuffer 4 6 (wWidth,wHeight) (bmWidth,bmHeight) (-1,-1))
    
    where
    bufferOffset = plusPtr nullPtr . fromIntegral

instance Render Bitmap where
    render bitmap@(Bitmap vArray _ _ _ iCount _ _ _) = do
...
instance Shutdown Bitmap where
    shutdown (Bitmap vArray vBuffer iBuffer _ _ _ _ _) = do
