pub mod mesh {
    ...
    impl VertexArray {
        ...
        pub fn new_lit(gl: Rc<gl::Gl>, vertices: Vec<f32>, indices: Vec<u8>) -> Self {
            let mut vertex_array = 0;
            let mut vertex_buffer = 0;
            let mut index_buffer = 0;
            ...
            unsafe {
                ...
                gl.VertexAttribPointer(0, 3, gl::FLOAT, gl::FALSE, (FLOAT_SIZE * 6) as i32, ptr::null());
                gl.EnableVertexAttribArray(0);

                gl.VertexAttribPointer(1, 3, gl::FLOAT, gl::FALSE, (FLOAT_SIZE * 6) as i32, ((3 * FLOAT_SIZE) as *const usize).cast());
                gl.EnableVertexAttribArray(1);
        ...
        pub fn new_pos(gl: Rc<gl::Gl>, vertices: Vec<f32>, indices: Vec<u8>) -> Self {
            let mut vertex_array = 0;
            let mut vertex_buffer = 0;
            let mut index_buffer = 0;
