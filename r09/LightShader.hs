...
initialize = do
    ...
    then return (False, Nothing)
        ...
        let success = all (/= -1) [world,view,projection,texture,direction,diffuse,ambient]
...
parameters (LightShader program _ world view projection texture direction diffuse ambient)
